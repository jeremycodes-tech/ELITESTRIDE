        ...
        {isMobile ? (
          ...
          <>
            <div className="nav-logo">
              <img src="images/W.png" alt={navigationConfig.logo} className="w-[1750px] lg:w-[220px] xl:w-[280px] object-contain filter invert hover:opacity-75 transition-opacity" />
            </div>
